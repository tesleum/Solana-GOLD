    ...
    <Box sx={{ animation: 'fadeIn 0.4s ease-out', pb: 12 }}>
      ...
      {!effectiveAddress ? (
        ...
        <Stack spacing={3}>
          ...
          {/* TAB 2: usGOLD STAKING & MINTING VAULT SUMMARY */}
          {(walletTab === 'staking' || walletTab === 'overview') && (
            <Card sx={{ 
              ...
              <CardContent sx={{ p: { xs: 3, md: 4 }, position: 'relative', zIndex: 1 }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                    <Box sx={{ p: 1.2, bgcolor: alpha('#D4AF37', 0.15), borderRadius: '14px', border: `1px solid ${alpha('#D4AF37', 0.3)}` }}>
                    ...
                    <Box>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        {t('stakingVault', language) || "usGOLD Staking Vault"} • Guaranteed 2% Monthly Fixed Return
                      </Typography>
                    </Box>
                  </Box>
                  <Chip label="2% Monthly APY" size="small" sx={{ bgcolor: alpha('#D4AF37', 0.2), color: '#FFDF73', fontWeight: 'bold' }} />
                </Box>

                <Grid container spacing={3} alignItems="center">
                  <Grid item xs={12} sm={6}>
                    <Typography variant="overline" color="text.secondary" fontWeight="700">
                      Active Staked Reserve
                    </Typography>
                    <Typography variant="h3" fontWeight="900" color="#D4AF37" sx={{ my: 0.5 }}>
                      {usGoldBalance.toFixed(2)} <span style={{ fontSize: '1rem', color: '#888' }}>GOLD</span>
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                      Estimated Reserve Value: ${usGoldUsdValue.toFixed(2)} USD
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    >
                      {t('openStakingVault', language) || "Go to Staking Page"}
                    </Button>
                  </Grid>
                </Grid>
              </CardContent>
